...
public class ChongdianzhuangOrderView extends ChongdianzhuangOrderEntity implements Serializable {
	...
	*/
	...
	private String chongdianzhuangOrderValue;
	...
	public ChongdianzhuangOrderView() {

	}

	public ChongdianzhuangOrderView(ChongdianzhuangOrderEntity chongdianzhuangOrderEntity) {
		try {
			BeanUtils.copyProperties(this, chongdianzhuangOrderEntity);
	...
	* 获取： 订单类型的值
	*/
	public String getChongdianzhuangOrderValue() {
		return chongdianzhuangOrderValue;
	}
	/**
	* 设置： 订单类型的值
	*/
	public void setChongdianzhuangOrderValue(String chongdianzhuangOrderValue) {
		this.chongdianzhuangOrderValue = chongdianzhuangOrderValue;
	}
	...
	public String toString() {
		return "ChongdianzhuangOrderView{" +
			", chongdianzhuangOrderValue=" + chongdianzhuangOrderValue +
